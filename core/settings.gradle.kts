...
include("opentaint-python-querylang")
include("samples")
...
includeBuild("opentaint-configuration-rules") {
    dependencySubstitution {
        substituteProjects("org.opentaint.opentaint-configuration-rules", listOf("configuration-rules-common", "configuration-rules-jvm", "configuration-rules-go", "configuration-rules-python"))
    }
}
