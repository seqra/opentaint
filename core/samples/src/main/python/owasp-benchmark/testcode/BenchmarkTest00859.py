...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00859', methods=['GET'])
	def BenchmarkTest00859_get():
		return BenchmarkTest00859_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00859', methods=['POST'])
