...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00775', methods=['GET'])
	def BenchmarkTest00775_get():
		return BenchmarkTest00775_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00775', methods=['POST'])
