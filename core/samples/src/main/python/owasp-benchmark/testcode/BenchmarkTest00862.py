...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00862', methods=['GET'])
	def BenchmarkTest00862_get():
		return BenchmarkTest00862_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00862', methods=['POST'])
