...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00690', methods=['GET'])
	def BenchmarkTest00690_get():
		return BenchmarkTest00690_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00690', methods=['POST'])
