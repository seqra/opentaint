...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00765', methods=['GET'])
	def BenchmarkTest00765_get():
		return BenchmarkTest00765_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00765', methods=['POST'])
