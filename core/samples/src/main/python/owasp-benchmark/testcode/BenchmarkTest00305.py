...
def init(app):
	...
	@app.route('/benchmark/weakrand-01/BenchmarkTest00305', methods=['GET'])
	def BenchmarkTest00305_get():
		return BenchmarkTest00305_post()

	@app.route('/benchmark/weakrand-01/BenchmarkTest00305', methods=['POST'])
