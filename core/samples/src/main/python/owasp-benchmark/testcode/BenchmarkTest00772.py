...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00772', methods=['GET'])
	def BenchmarkTest00772_get():
		return BenchmarkTest00772_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00772', methods=['POST'])
