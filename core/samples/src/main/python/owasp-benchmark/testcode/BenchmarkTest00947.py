...
def init(app):
	...
	@app.route('/benchmark/weakrand-03/BenchmarkTest00947', methods=['GET'])
	def BenchmarkTest00947_get():
		return BenchmarkTest00947_post()

	@app.route('/benchmark/weakrand-03/BenchmarkTest00947', methods=['POST'])
