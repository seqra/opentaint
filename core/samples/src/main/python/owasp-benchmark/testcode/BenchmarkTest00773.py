...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00773', methods=['GET'])
	def BenchmarkTest00773_get():
		return BenchmarkTest00773_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00773', methods=['POST'])
