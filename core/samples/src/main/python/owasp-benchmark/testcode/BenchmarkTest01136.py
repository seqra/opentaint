...
def init(app):
	...
	@app.route('/benchmark/weakrand-03/BenchmarkTest01136', methods=['GET'])
	def BenchmarkTest01136_get():
		return BenchmarkTest01136_post()

	@app.route('/benchmark/weakrand-03/BenchmarkTest01136', methods=['POST'])
