...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00766', methods=['GET'])
	def BenchmarkTest00766_get():
		return BenchmarkTest00766_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00766', methods=['POST'])
