...
def init(app):
	...
	@app.route('/benchmark/weakrand-03/BenchmarkTest00954', methods=['GET'])
	def BenchmarkTest00954_get():
		return BenchmarkTest00954_post()

	@app.route('/benchmark/weakrand-03/BenchmarkTest00954', methods=['POST'])
	def BenchmarkTest00954_post():
		...
		map36088 = {}
		map36088['keyA-36088'] = 'a-Value'
		map36088['keyB-36088'] = param
		map36088['keyC'] = 'another-Value'
		bar = "safe!"
		bar = map36088['keyB-36088']
		bar = map36088['keyA-36088']

		import secrets
		from helpers.utils import mysession

		num = 'BenchmarkTest00954'[13:]
