...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00860', methods=['GET'])
	def BenchmarkTest00860_get():
		return BenchmarkTest00860_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00860', methods=['POST'])
