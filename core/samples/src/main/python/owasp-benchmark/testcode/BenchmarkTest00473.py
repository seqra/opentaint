...
def init(app):
	...
	@app.route('/benchmark/weakrand-01/BenchmarkTest00473', methods=['GET'])
	def BenchmarkTest00473_get():
		return BenchmarkTest00473_post()

	@app.route('/benchmark/weakrand-01/BenchmarkTest00473', methods=['POST'])
