...
def init(app):
	...
	@app.route('/benchmark/weakrand-03/BenchmarkTest00945', methods=['GET'])
	def BenchmarkTest00945_get():
		return BenchmarkTest00945_post()

	@app.route('/benchmark/weakrand-03/BenchmarkTest00945', methods=['POST'])
	def BenchmarkTest00945_post():
		...
		bar = map54148['keyA-54148']

		import random
		from helpers.utils import mysession

		num = 'BenchmarkTest00945'[13:]
		user = f'Randy{num}'
