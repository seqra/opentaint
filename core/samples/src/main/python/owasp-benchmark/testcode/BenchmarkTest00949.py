...
def init(app):
	...
	@app.route('/benchmark/weakrand-03/BenchmarkTest00949', methods=['GET'])
	def BenchmarkTest00949_get():
		return BenchmarkTest00949_post()

	@app.route('/benchmark/weakrand-03/BenchmarkTest00949', methods=['POST'])
