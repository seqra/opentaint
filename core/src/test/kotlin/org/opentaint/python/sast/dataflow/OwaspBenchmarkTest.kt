...
class OwaspBenchmarkTest : AnalysisTest() {
    ...
    @Disabled("FN inv 29: taint reaches escape_for_html(param) (verified via call-arg probe) but the helper's char-rebuild body 'for c in s: ret += c' drops it (scalar NextIter, inv-25 family); config passthrough can't override an analyzed user fn")
