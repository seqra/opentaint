...
private class TraceActionCollector(
    ...
    private sealed interface Evaluation {
        data class Valid(val rules: ActionableRules) : Evaluation
    ...
    private fun evaluateFullTrace(
        ...
        val entryRules = hashMapOf<Int, ActionableRules>()
    ...
    private fun sinkRuleMap(): ActionableRules {
...
private class RulesAccumulator {
    ...
    fun addAll(other: ActionableRules) {
    ...
    fun freeze(): ActionableRules = rules.mapValues { (_, statementRules) ->
