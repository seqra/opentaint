...
private fun Set<Accessor>.persistentAdd(accessor: Accessor): Set<Accessor> =
    when (this) {
...
private fun Set<Accessor>.persistentAddAll(other: Set<Accessor>): Set<Accessor> =
    when (this) {
...
private fun Set<Accessor>.persistentRetainAll(other: Set<Accessor>): Set<Accessor> =
    when (this) {
...
private fun Set<Accessor>.persistentRemove(accessor: Accessor): Set<Accessor> =
    when (this) {
...
private fun Set<Accessor>.persistentRemoveAll(other: Set<Accessor>): Set<Accessor> =
    when (this) {
