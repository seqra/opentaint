...
TL;DR: Το OpenTaint είναι μια εναλλακτική ανοιχτού κώδικα στα *Semgrep Pro* και *CodeQL* — μια τυπική δια-διαδικαστική μηχανή taint που μπορείτε να προσαρμόσετε και να φιλοξενήσετε μόνοι σας, φτιαγμένη ώστε οι πράκτορες AI να καθοδηγούν την ανάλυση ασφαλείας σας χωρίς να ξοδεύουν tokens σε κάθε σάρωση.
...
- **Βρείτε αυτά που χάνουν οι μηχανές αντιστοίχισης μοτίβων.** Μια τυπική δια-διαδικαστική μηχανή ροής δεδομένων παρακολουθεί μη αξιόπιστα δεδομένα πέρα από όρια συναρτήσεων, επίπεδα αποθήκευσης, ψευδώνυμα και ασύγχρονο κώδικα.
