...
TL;DR: OpenTaint เป็นทางเลือกแบบโอเพนซอร์สแทน *Semgrep Pro* และ *CodeQL* — เอนจินวิเคราะห์ taint แบบ inter-procedural ที่เป็นทางการ ซึ่งคุณสามารถปรับแต่งและโฮสต์เองได้ สร้างขึ้นเพื่อให้ AI agent ขับเคลื่อนการวิเคราะห์ความปลอดภัยของคุณโดยไม่เผาผลาญโทเค็นในทุกการสแกน
...
- **เครื่องมือจับคู่รูปแบบ** (Semgrep OSS, ast-grep, ลินเตอร์) นั้นฟรีและรวดเร็ว แต่มันจับคู่ไวยากรณ์ ไม่ใช่การไหลของข้อมูล — อินพุตที่ไม่น่าเชื่อถือซึ่งข้ามขอบเขตฟังก์ชันหรือชั้นจัดเก็บข้อมูลจะหลุดผ่านไปได้ การวิเคราะห์ inter-procedural ที่ลึกกว่าซึ่ง *จับได้* จริงนั้นถูกล็อกไว้ในเครื่องมือเชิงพาณิชย์มานาน
...
- **ค้นพบสิ่งที่เครื่องมือจับคู่รูปแบบพลาด** เอนจิน dataflow แบบ inter-procedural ที่เป็นทางการติดตามข้อมูลที่ไม่น่าเชื่อถือข้ามขอบเขตฟังก์ชัน ชั้นจัดเก็บข้อมูล นามแฝง และโค้ดแบบอะซิงโครนัส
