...
| `isAbstract` | logical graph contains abstract acceptance | none beyond projected abstraction | inspect suffix marker only; call every empty delta concrete | exact against projected graph |
